<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_HeadWiseValuation.aspx.cs" Inherits="IMS_PowerDept.Print_Reports.Report_HeadWiseValuation" %>
                                                  ...
                                                  <%--     <asp:Label ID="ete" Font-Bold="true" Font-Size="14px" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container, "DataItem.DeliveryItemsChallanID ")%>'></asp:Label>--%>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td>
                                                    <asp:GridView ID="GridView2" OnRowCreated="GridView2_RowCreated" Width="500px" GridLines="None" ShowFooter="true" AutoGenerateColumns="false" 
                                                                OnRowDataBound="GridView2_RowDataBound" runat="server">
                                                                <Columns>
