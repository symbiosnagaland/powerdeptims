<%@ Page Title="Receipt Entries List" Language="C#" MasterPageFile="~/Shared/Transformers_Master.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ReceiptEntriesList.aspx.cs" Inherits="IMS_PowerDept.Transformers.ReceiptEntriesList" %>
...
<div class="full_w">
				...
				<div class="h_title">List Receipt Entries</div>
             ...
             <ItemTemplate>
                 ...
                 <tr>
                     ...
                     <td> <asp:Label ID="cHEad" runat="server" Text='<%#Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.ChallanDate")).ToString("yyyy-MM-dd") %>'></asp:Label>
                       ...
                       <td>
                           <asp:Label ID="Label2" runat="server" Text='<%#Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.ReceiptDate")).ToString("yyyy-MM-dd") %>'></asp:Label>
                       
                     </td>
                     <td>
                            <asp:Label ID="Label3" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.Division")%>'></asp:Label>
                         </td>
                     <td>
                            <asp:Label ID="Label4" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.ProbableCause")%>'></asp:Label>
                     ...
                     <td>
                           ...
                           <a href='<%# "ReceiptEntryDetails.aspx?challanno="+Eval("ChallanNo") %>' class="table-icon archive" title="View Details"></a>
                     </td>
                 </tr>
