  ...
  <div style="padding:10px; width:810px;">
    ...
    <h2 style="margin:4px">Division-wise Issue of Materials</h2>
      ...
      <table style="width:800px;">
          <tr>
              <td>
<asp:GridView AutoGenerateColumns="false" GridLines="None" OnRowDataBound="gvChargeableHead_RowDataBound"  ID="gvChargeableHead" runat="server" ShowHeader="False" Width="800px">
          <Columns>
              <asp:TemplateField>
                  <ItemTemplate>
