...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:SqlDataSource ID="sds" runat="server" ConnectionString="<%$ ConnectionStrings:PowerDeptNagalandIMSConnectionString_server %>" SelectCommand="SELECT DISTINCT IssueHeadName FROM DeliveryItemsDetails"></asp:SqlDataSource>
     ...
     <asp:SqlDataSource ID="iheads" runat="server" ConnectionString="<%$ ConnectionStrings:PowerDeptNagalandIMSConnectionString_server %>" SelectCommand="select distinct IssueHeadName from ItemsInventory"></asp:SqlDataSource>
        ...
        <div id="tab-4">
            ...
            <ContentTemplate>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="form-control" Enabled="false" ID="stratdiv" placeholder="Begin Date" Width="220px" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                          <asp:TextBox CssClass="form-control" Enabled="false" ID="enddiv" placeholder="Ending Date" Width="220px" runat="server"></asp:TextBox>
			...
			<div class="content">
                ...
                <asp:Button ID="Button3" CssClass="btn btn-primary" runat="server" Text="Generate Balance Sheet" OnClick="Button3_Click" />
                      ...
                      <tr>
                          ...
                          <td>
                              <asp:DropDownList ID="DropDownList1" Width="250px"  runat="server" DataSourceID="iheads" DataTextField="IssueHeadName" DataValueField="IssueHeadName" ></asp:DropDownList>
                          </td>
                          <td>
