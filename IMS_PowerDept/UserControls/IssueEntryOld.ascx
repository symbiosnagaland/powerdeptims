<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IssueEntryOld.ascx.cs" Inherits="IMS_PowerDept.UserControls.IssueEntry" %>
...
<div class="full_w">
    ...
    <div style="margin: 0px auto; padding: 10px">
        ...
        <div class="half_w half_right">
            ...
            <div style="margin: 0px auto; padding: 10px">
                <asp:TextBox CssClass="form-control" ID="_tbIndentValue" placeholder="Indent Number" Width="180px" runat="server"></asp:TextBox>
                <br />
                <asp:TextBox CssClass="form-control" ID="_tbIntendDate" placeholder="Date" Width="180px" runat="server"></asp:TextBox>
        ...
        <div class="element2">
            ...
            <asp:TextBox CssClass="form-control" ID="tbItemsRows" TextMode="Number" Text="38" Width="30px" runat="server"></asp:TextBox></span>
