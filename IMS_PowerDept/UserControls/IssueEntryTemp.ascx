...
<script type="text/javascript">
    ...
    function calculateQtySum() {
       ...
       // document.getElementById("<%= gvItems.ClientID%>tbtotalAmount").value = sum;
        document.getElementById("ContentPlaceHolder1_IssueEntryTemp_gvItems__tbTotalQty").value = sum;
...
<div class="full_w">
    ...
    <div style="margin: 0px auto; padding: 10px">
        ...
        <div class="element2">
            <asp:CheckBox ID="istemporary" Text=" Select if Issued Entry is Temporary" Enabled ="false"  Checked ="True" Visible="true"  runat="server" ForeColor="Red" />
        </div>
