<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssuedItemsDetails.aspx.cs" Inherits="IMS_PowerDept.CentralStore.IssueEntry_Details" %>
         ...
         <asp:ListView ID="_lvdetails" OnItemCommand="_lvdetails_ItemCommand" OnItemDataBound="_lvdetails_ItemDataBound" runat="server" DataSourceID="_sdsChallan">
            <ItemTemplate>
                         ...
                         <tr>
                             ...
                             <td><asp:Label ID="ref" Font-Size="14px" Font-Bold="true" runat="server" Text='  <%#DataBinder.Eval(Container, "DataItem.IndentReference")%>'></asp:Label></td>
                             <td>Indent Date</td>
                             <td><asp:Label ID="idate" Font-Size="14px" Font-Bold="true" runat="server" Text='  <%#DataBinder.Eval(Container, "DataItem.IndentDate", "{0:dd/MM/yyyy}")%>'></asp:Label></td>
                         </tr>
                         <tr>
                                <td>Division Name</td>
                             <td><asp:Label ID="Label1" Font-Size="14px" Font-Bold="true" runat="server" Text='<%#DataBinder.Eval(Container, "DataItem.IndentingDivisionName")%>'></asp:Label></td>
                             <td>Head Name</td>
                             <td><asp:Label ID="Label2" Font-Size="14px" Font-Bold="true" runat="server" Text='  <%#DataBinder.Eval(Container, "DataItem.ChargeableHeadName")%>'></asp:Label></td>
                         </tr>
                             <tr>
                                 <td>
                                     Status :
...
<tr >
    ...
    <td ><b> <%# Container.DataItemIndex+1 %>.</b> </td>
                     ...
                     <td ><asp:Label ID="Label4" CssClass="labelet" runat="server" Text='  <%#DataBinder.Eval(Container, "DataItem.IssueHeadName")%>'></asp:Label></td>
