        ...
        <asp:Panel ID="panelAdvancedSearchFilters"  runat="server">
            ...
            <div class="element2">
                ...
                <table >
                    ...
                    <asp:DropDownList CssClass="err" ID="_istemp" Width="250px" runat="server" AutoPostBack="true" AppendDataBoundItems="true" OnSelectedIndexChanged="_istemp_SelectedIndexChanged" >
                    ...
                    <tr>
                            ...
                            <td> 
                                <span style="float: left; padding-left: 10px; width: 47%;">
                                     <input type="text" class="form-control" id="_txtsearch" runat="server" style="height: 22px; width:225px" placeholder="Search Keyword..." />
                                </span>
                    ...
                    <label>Search between  dates </label>
                        ...
                        <td>
                             <span style="float: left; padding-left: 10px;">
                                    <asp:TextBox CssClass="form-control" ID="tbStartDateSearch" autocomplete="off" placeholder="dd/mm/yyyy" Width="100px" runat="server"></asp:TextBox>
                                </span>

                             <span style="float: left; padding-left: 10px;">
                                <asp:TextBox CssClass="form-control" ID="tbEndDateSearch" autocomplete="off" placeholder="dd/mm/yyyy" Width="100px" runat="server"></asp:TextBox>
                            </span>
