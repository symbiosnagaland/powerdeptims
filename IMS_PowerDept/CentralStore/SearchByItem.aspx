...
<div style="margin:0px auto;padding:10px">
     ...
     <div style="width: 860px; overflow: auto;">
       ...
       <asp:TemplateField HeaderText="Action" ItemStyle-Width="200px"> <ItemTemplate>                     
    ...
    Item Issued List
         ...
         <asp:GridView ID="gvItemsIssued" Width="98%" GridLines="None" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"  PageSize="20" OnDataBound="gvItemsIssued_DataBound1" OnPageIndexChanged="gvItemsIssued_PageIndexChanged" OnPageIndexChanging="gvItemsIssued_PageIndexChanging">
          ...
          <asp:BoundField DataField="Rate" HeaderText="Rate" />
          <asp:BoundField DataField="Quantity" HeaderText="Quantity" />
                  <asp:TemplateField HeaderText="Action" ItemStyle-Width="200px"> <ItemTemplate>  <a href='<%# "IssuedItemsDetails.aspx?Id="+Eval("DeliveryItemsChallanID") %>' target="_blank" class="table-icon archive" style="padding-left:20px;" title="View Details">View</a> </ItemTemplate>  </asp:TemplateField>
