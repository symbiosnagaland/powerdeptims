<%@ Page Title=" Run Valuation Reports" Language="C#" MasterPageFile="~/Shared/Admin_Master.Master" AutoEventWireup="true" CodeBehind="RunValuationReports.aspx.cs" Inherits="IMS_PowerDept.Admin.RunValuationReports" %>
		...
		<div id="tab-1">
            ...
            <ContentTemplate>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="form-control" ID="tbStartDateSearch" TextMode="Date" placeholder="Begin Date" Width="220px" runat="server"></asp:TextBox>
                    </td>
                </tr>
                    <tr>
                    <td>
                    ...
                    <td>
                          <asp:TextBox CssClass="form-control" ID="tbEndDateSearch" TextMode="Date" placeholder="Ending Date" Width="220px" runat="server"></asp:TextBox>

                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                         <asp:Button ID="btnSearch" OnClientClick ="document.forms[0].target = '_blank';"  CssClass="btn btn-primary" runat="server" Text="Search Between Dates" OnClick="btnSearch_Click" />
                    </td>
                </tr>   
        ...
        <div id="tab-4">
            ...
            <ContentTemplate>
					<table style="width:100%">
                        <tr>
                            <td>
                                <asp:CheckBox ID="ck1" EnableViewState="true" AutoPostBack="true" OnCheckedChanged="ck1_CheckedChanged" Text="Preview by Division and Date" runat="server" />
                            </td>
                             <td>
                 ...
                 <asp:DropDownList CssClass="err" Enabled="false"  EnableViewState="true" AutoPostBack="true" OnSelectedIndexChanged="ddldiv_SelectedIndexChanged" AppendDataBoundItems="True" ID="ddldiv" Width="250px" runat="server" DataSourceID="divname" DataTextField="IndentingDivisionName" DataValueField="IndentingDivisionName">
                    </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="form-control" TextMode="Date" Enabled="false" ID="stratdiv" placeholder="Begin Date" Width="220px" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                          <asp:TextBox CssClass="form-control" TextMode="Date" Enabled="false" ID="enddiv" placeholder="Ending Date" Width="220px" runat="server"></asp:TextBox>
