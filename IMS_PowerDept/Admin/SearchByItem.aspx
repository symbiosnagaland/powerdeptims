...
<div style="margin:0px auto;padding:10px">
       ...
       <div style="width: 860px; overflow: auto;">
		...
		<tr class="sortasc sortdesc" style="color:White;">
			<th scope="col">Total Received</th><th scope="col">Total Issued</th><th scope="col">Balance</th>
		</tr><tr>
			<td style="width:11%;">
                   <asp:Label ID="LblTotal1" runat="server" Font-Bold="true" Visible="false" Text=" 0"></asp:Label>


			</td><td style="width:11%;">   <asp:Label ID="LblTotal2" runat="server" Font-Bold="true" Visible="false" Text=" 0" ></asp:Label>

			     </td>
            
            <td style="width:11%;"> <asp:Label ID="lblTotalBalance" runat="server" Font-Bold="true" Visible="false" Text=" 0" ></asp:Label></td>
    ...
    <h3>
     ...
     <div style="width: 860px; overflow: auto;">
       ...
       <asp:TemplateField HeaderText="Action" ItemStyle-Width="200px"> <ItemTemplate>  <a href='<%# "ReceivedItemsEdit.aspx?oteoid="+Eval("ReceivedItemsOTEOID") %>' class="table-icon edit" style="padding-left:20px;" title="Edit">Edit</a>                        
                         <a  href='<%# "ReceivedItemsDetails.aspx?Id="+Eval("ReceivedItemsOTEOID") %>' style="padding-left:20px;"  target="_blank" class="table-icon archive" title="View Details">View</a>  </ItemTemplate>  </asp:TemplateField>
...
<h3>
    ...
    Item Issued List
         ...
         <%--    <asp:Label ID="Label2" runat="server" Visible="false" Text="Total Issued Quantity = "></asp:Label>--%>
          ...
          <asp:BoundField DataField="Rate" HeaderText="Rate" />
          <asp:BoundField DataField="Quantity" HeaderText="Quantity" />
          <asp:TemplateField HeaderText="Action" ItemStyle-Width="200px"> <ItemTemplate> <a href='<%# "IssuedEntryEdit.aspx?challanid="+Eval("DeliveryItemsChallanID") %>' class="table-icon edit" style="padding-left:20px;" title="Edit">Edit</a> <a href='<%# "IssuedItemsDetails.aspx?Id="+Eval("DeliveryItemsChallanID") %>' target="_blank" class="table-icon archive" style="padding-left:20px;" title="View Details">View</a> </ItemTemplate>  </asp:TemplateField>
