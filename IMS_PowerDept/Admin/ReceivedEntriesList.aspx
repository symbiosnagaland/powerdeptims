...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="element2">
            <table>
                            ...
                            <td> 
                                <span style="float: left; width: 55%; padding-left:10px;">
                                 ...
                                 <span class="input-group-btn" style="float: left; height: 50px; width:10px; padding-left:2px;">
                                     <button runat="server" id="btnSearchImage" class="btn btn-default" title="click to search" onserverclick="btnSearchImage_ServerClick" type="button"  style="height: 36px; width:30px; border-top-left-radius: 0px; border-bottom-left-radius: 0px;">
                ...
                <tr>
                    <td><span style="float: left;"><label for="comments">Issue Head </label></span></td>
                    ...
                    <td>
                        <span style="float: left; padding-left: 10px;">
                            ...
                            <asp:ListItem Text="All" Value="%"/></asp:DropDownList>
                        </span>
                    </td>
                ...
                <tr>
                    <td><span style="float: left;"><label for="comments">Chargeable Head</label></span></td>
                ...
                <tr>
                    <td> <span style="float: left;"><label>Search between OTEO/Supply Order dates </label></span></td>
