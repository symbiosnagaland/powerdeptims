<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_ChallanWiseValuationPrintFilter.aspx.cs" Inherits="IMS_PowerDept.PrintReports.Report_ChallanWiseValuationPrintFilter" %>
...
<body onload="javascript:window.print()">
   ...
   <div style="padding:10px; width:892px; margin:0px auto">
    <h2 style="margin:4px">Monthly Issue Head-wise Valuation</h2>
     
      For Issues Between:&nbsp; <asp:Label ID="st" runat="server" Text=""></asp:Label>
       &nbsp; and
       <asp:Label ID="ed" runat="server" Text=""></asp:Label>
       <hr />
        <asp:SqlDataSource ID="sds1" runat="server" ConnectionString="<%$ ConnectionStrings:PowerDeptNagalandIMSConnectionString_server %>" SelectCommand="select distinct IssueHeadName  from DeliveryItemsDetails"></asp:SqlDataSource>
    <table>
            ...
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <tr>
                            <td>
                                <asp:Label ID="_lbldivi" runat="server" Font-Size="16px" Font-Bold="true" Text='<%#DataBinder.Eval(Container, "DataItem.IssueHeadName")%>'></asp:Label>
                            </td>
                        </tr>
