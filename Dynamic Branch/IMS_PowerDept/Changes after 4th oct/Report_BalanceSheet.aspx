<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_BalanceSheet.aspx.cs" Inherits="IMS_PowerDept.PrintReports.Report_BalanceSheet" %>
...
<body onload="javascript:window.print()">
  ...
  <div style="padding:10px; width:810px;">
    ...
    <%--  <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ConnectionString="<%$ ConnectionStrings:PowerDeptNagalandIMSConnectionString_server %>" SelectCommand="select  itemid, ItemName,GrossBalance, issueheadname from ItemsInventory  where (GrossBalance <>0 and NetActualBalance <>0) order by ItemName"></asp:SqlDataSource>
       <hr />
