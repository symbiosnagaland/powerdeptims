<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transformer_Receipts.aspx.cs" Inherits="IMS_PowerDept.PrintReports.Transformer_Receipts" %>
...
<body onload="javascript:window.print()">
    ...
    <div style="padding:10px; margin:0px auto; width: 961px;">
      <h2 style="margin:4px">Transformer Receipt Details </h2>
                                            ...
                                            <thead>
                                             <tr>
                                               ...
                                               <td style="text-align:left; font-size:16px; font-weight:bold;  width:10%"> 
                                                 ...
                                                 <td style="text-align:left; font-size:16px; font-weight:bold;  width:13%">
                                                  Receipt Date</td>
                                ...
                                <asp:Repeater ID="_gridChEdit" runat="server" >
                                    <ItemTemplate>
                                           <tr>
                                                ...
                                                <asp:Label ID="cHEad" runat="server" Text='  <%#DataBinder.Eval(Container, "DataItem.challanno")%>'></asp:Label>
                                                  ...
                                                  <td >                                                
                                                    <asp:Label ID="Label1" runat="server" Width="90px" Text=' <%#DataBinder.Eval(Container, "DataItem.challandate","{0:dd/MM/yyyy}")%>'></asp:Label>
                                                        ...
                                                        <td >                                                   
                                                    <asp:Label ID="Label5" runat="server" Width="90px" Text=' <%#DataBinder.Eval(Container, "DataItem.receiptdate","{0:dd/MM/yyyy}")%>'></asp:Label>
                                                </td>
                                            ...
                                            <td > 
                                                <asp:Label ID="Label4" runat="server" Text='  <%#DataBinder.Eval(Container, "DataItem.seriel")%>'></asp:Label>
                                                                </td>   <td >
                                                <asp:Label ID="Label6" runat="server" Text='  <%#DataBinder.Eval(Container, "DataItem.Oil")%>'></asp:Label>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h3>
                                                        Total Receipts:  <asp:Label ID="lblCount" runat="server" ></asp:Label>
                                                    </h3>
                                                            </td>
                                                </tr>
                                 </table>
