<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transformer_Jobs.aspx.cs" Inherits="IMS_PowerDept.PrintReports.Transformer_Jobs" %>
...
<body onload="javascript:window.print()">
    ...
    <div style="padding:10px; margin:0px auto; width: 961px;">
      <h2 style="margin:4px">Transformer Job Details </h2>
       ...
       <hr />
                                ...
                                <asp:Repeater ID="_gridChEdit" runat="server" >
                                    <ItemTemplate>
                                           <tr>
                                                 <td>                                                   
                                                    <asp:Label ID="aa" runat="server" Text=' <%#DataBinder.Eval(Container, "DataItem.repairfirm")%>'></asp:Label>
                                                </td>
                                            <td >
                                            ...
                                            <td > 
                                                ...
                                                <asp:Label ID="Label5" runat="server" Text='  <%#DataBinder.Eval(Container, "DataItem.seriel")%>'></asp:Label>
                                                     ...
                                                     <td >
                                                <asp:Label ID="Label7" runat="server" Text='  <%#DataBinder.Eval(Container, "DataItem.jobno")%>'></asp:Label>
