...
{
    public partial class Report_TempIssuedItems : System.Web.UI.Page
    {
        string ch_headvalue = "";
        ...
        protected void gvChargeableHead_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                SqlCommand cmd = new SqlCommand("Select * from DeliveryItemsChallan where ChargeableHeadName='" + DEP_ID.Text.ToString() + "'and (challandate between @startdate and @enddate)", con);
