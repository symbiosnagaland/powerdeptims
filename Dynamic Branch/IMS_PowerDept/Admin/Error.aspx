<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="IMS_PowerDept.Admin.Error" %>
			...
			<ul>
                ...
                <uc1:menuPartial runat="server" ID="menuPartial" />
					...
					<ul>
						...
						<li>&#8250; <a href="User_New.aspx">Add new User</a></li>
							<li>&#8250; <a href="User_Setting.aspx">Manage Users</a></li>
