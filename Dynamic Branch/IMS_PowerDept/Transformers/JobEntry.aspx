<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Transformers_Master.Master" AutoEventWireup="true" CodeBehind="JobEntry.aspx.cs" Inherits="IMS_PowerDept.Transformers.JobEntry" %>
...
<div class="full_w">
    <div class="h_title">Job Entry</div>
    ...
    <p><asp:Label ID="lblError" runat="server" Text=""></asp:Label></p>
        ...
        <div class="element">
            <label for="comments">Repair Firm</label>
            <asp:DropDownList CssClass="err" ID="_ddlRepairFirm" Width="250px" runat="server">
            </asp:DropDownList>
        </div>
            ...
            <asp:GridView ShowFooter="true" EmptyDataText="Empty Rows" ShowHeader="true" ID="gvItems" OnRowDataBound="gvItems_RowDataBound" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" BackColor="White">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Job No.">
                        <ItemTemplate>
                         <asp:TextBox Width="150px" ID="tbJobNo"  CssClass="form-control" runat="server">
                            </asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
